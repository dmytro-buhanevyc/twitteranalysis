...
st.markdown(
    ...
    **👈 Select a project from the menu on the left**
    ...
    - This TCA Data Lab demo currently hosts two complete projects.
        - News visualizes Twitter data from official news sources in three select countries (France, Germany, Italy).
    ...
    - Data visualizations (graphs) can be extracted as images. 
